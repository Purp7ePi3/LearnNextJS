...
async function fetchApod() {
    ...
    if (!apiKey) throw new Error("Nasa api missing");
...
async function GET() {
    try {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$nasa$2d$app$2f$app$2f$lib$2f$nasa$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchApod"])();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$nasa$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to fetch NASA API"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3e6d67f._.js.map